<h1>Cadastrar Advocacia</h1>
<form action="?page=advocacia-salvar" method="POST">
	<input type="hidden" name="acao" value="cadastrar">
	<div class="form-group">
		<label>Nome da Advocacia</label>
		<input type="text" placeholder="Nome" name="nome_advocacia" class="form-control">
		<label>Endereço da Advocacia</label>
		<input type="text" placeholder="Endereço" name="end_advocacia" class="form-control">
		<label>Telefone da Advocacia</label>
		<input type="text" placeholder="Telefone" name="tel_advocacia" class="form-control">
	</div>
	<div class="form-group">
